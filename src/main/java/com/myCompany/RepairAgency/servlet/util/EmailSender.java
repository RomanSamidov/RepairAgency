...
//           message.setText(msg);
     ...
     EmailSender.send("roman.samidov@gmail.com","hello javatpoint","How r u?"
             ,new File("reports/report[2](1).xls")
             ,new File("reports/report[2](1).xlsx")
             ,new File("reports/report[2](2).xlsx")
             ,new File("reports/report[2].xlsx")
             ,new File("reports/report[2].xls")
             ,new File("reports/report[2].pdf")
             );
